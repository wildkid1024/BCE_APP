...
public:
    ...
    Result ModelSetDynamicInfo(int dims0, int dims1);
    Result SetTensorDesc(int idx, int dims0, int dims1);
    ...
    Result CreateInput(std::vector<std::pair<void*, unsigned int> >& imageBufs);
    ...
    void OutputModelResult(std::vector<float>& outputs, int batch, int classNum);
